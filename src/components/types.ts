...
export interface Column<T = any> {
   ...
   * @default true
   */
  cellRenderer?: ((row: T) => string) | string | boolean
  /**
...
export interface Vue3DatatableChangeEvent {
  current_page: number
  pagesize: number
  offset: number
...
export interface Vue3DatatableEmits<T = any> {
 ...
 */
export interface Vue3DatatableProps<T = any> {
  /**
 ...
 */
export interface ColumHeaderEmits {
